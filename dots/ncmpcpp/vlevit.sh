...
MUSIC_DIR="~/.config/mpd/music"
# Path to output cover
COVER="/tmp/cover.jpg"
COVER_NOTIFICATION="/tmp/cover_notification.jpg"
# Size of cover
COVER_SIZE=297
...
#	album_dir="$MUSIC_DIR/$album_dir"
	...
	ffmpeg -y -i $input -vf "scale=-2:297" $COVER
#	ffmpeg -loglevel 0 -y -i "$file" -vf "crop=min(in_w-$CROP_BORDER\,in_h-$CROP_BORDER):out_w,scale=-2:$COVER_SIZE" "$COVER"
